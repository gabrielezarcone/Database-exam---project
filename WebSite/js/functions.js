...
function add_skills_form(id, opt){
    html ='<div class="uk-inline"><span class="uk-form-icon" uk-icon="icon: hashtag"></span><input class="uk-input" type="text" name="skill'+i+'" list="skills_list" placeholder="Select or add your own skill"></div><datalist id="skills_list">'+opt+'</datalist><input type="button" class="uk-button uk-button-default requester" onclick="removeElement(\'skill'+i+'\');" value="Remove">';
